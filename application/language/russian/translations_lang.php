...
$lang['no_available_hours'] = 'Нет доступного времени назначения на выбранной дате. Пожалуйста выберите другую дату.';
...
$lang['cancel_appointment_hint'] = 'Нажмите кнопку "Отмена" для удаления назначения из расписания ментора.';
...
$lang['appointment_cancelled_title'] = 'Встреча отменена';
$lang['reason'] = 'Причина';
...
$lang['manage_users_hint'] = 'Управление пользователями школа (администраторами, менторами, секретарями).';
